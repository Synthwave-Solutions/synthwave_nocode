...
This command will download everything that is needed to start n8n. You can then access n8n and start building workflows by opening [https://stream.synthwave.solutions/](https://stream.synthwave.solutions/).
